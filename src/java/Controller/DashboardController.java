...
public class DashboardController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("currentRevenue", dao.getCurrentMonthRevenue());
        request.setAttribute("unpaidInvoices", dao.getUnpaidInvoices());

        // Chuyển sang giao diện Bootstrap
